...
//                                 _buildIconButton(context, Icons.eco, GardenPage(), Colors.black),
...
//                 style: TextStyle(
//                   color: Color.fromARGB(255, 255, 255, 255), // Secondary color for the content
//                   fontSize: 16.0,
//                 ),
//               ),
...
//                     child: Text(
//                       "Log out",
//                       style: TextStyle(color: Color.fromARGB(255, 158, 158, 158)), // Secondary color for the logout button
//                     ),
//                   ),
//                 ],
//               ),
...
//   Widget build(BuildContext context) {
//     return Scaffold(
//       body: Center(child: Text('Location Page Content')),
//     );
//   }
// }
...
//   Widget build(BuildContext context) {
//     return Scaffold(
//       body: Center(child: Text('Lighting Page Content')),
//     );
//   }
// }
...
//   Widget build(BuildContext context) {
//     return Scaffold(
//       body: Center(child: Text('Garden Page Content')),
//     );
//   }
// }
...
import 'package:flutter/material.dart';
import 'package:iot/Scripts/StartPage.dart';
